...
// 데미지/주문검) 세분화 — CONCEPT_MATCHUPS/CONCEPT_PILOT_TIPS(compConcepts.ts,
...
// 정글/서포터로도 가는 마크스맨(Senna 서포터 등)이나 분류가 애매한 챔피언은
// 억지로 채우지 않고 뺐습니다.

export type AdcAttribute = "critAttackSpeed" | "attackSpeed" | "percentDamage" | "critDamage" | "spellblade";
...
export const ADC_ARCHETYPES: Record<string, AdcArchetype> = {
  ...
  Kalista: { attributes: ["attackSpeed"], flexibleBuild: false },
  Kindred: { attributes: ["critAttackSpeed"], flexibleBuild: false },
